...
RSpec.describe Types::QueryType do
  describe 'display postings' do
    it 'user can query all their borrow postings where they have responded to a lender' do
      ...
      posting3 = Posting.create(posting_type: 1, title: "Looking to borrow sprinkler", poster_id: @user.id, responder_id: @user.id)
      ...
      lawn.items.create(name: 'I would like to borrow my own sprinkler', quantity: 2.0, time_duration: 'days', available: true, posting_id: posting3.id)
